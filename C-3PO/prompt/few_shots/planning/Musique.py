EXAMPLES = [
    """Question: Where did the director of Bulworth attend school?\nQuestion Analysis:
"Bulworth" is the film in question, and we need to ascertain who the director of the film "Bulworth" is.
Find Educational Background: Once the director is identified, the goal is to determine where they attended school.
Step 1: Retrieve detailed information about `Who is the director of the film "Bulworth"?`, and identify the director.
Step 2: Retrieve information about `Where did the director of "Bulworth" attend school?`, and identify the school they attended.""",

    """Question: What is the largest employer in the birthplace of Black or White's producer?\nQuestion Analysis:
Identify the Producer of "Black or White": The core component of the question, as this will lead us to their birthplace.
Determine the Birthplace of the Producer: Once the producer is identified, the next step is to determine their birthplace.
Find the Largest Employer in that Location: The final step is to identify the largest employer in that specific location.
Step 1: Retrieve information about `Who is the producer of "Black or White"`, and identify the producer.
Step 2: Retrieve information about `What is the birthplace of the producer of "Black or White"`, and identify the location.
Step 3: Retrieve information about `What is the largest employer in the birthplace of the producer`, and provide the answer based on the retrieved information.""",
